...
namespace TMS_Sample
{
	public partial class TMS_SampleForm : Form
	{
        ...
        ///====================================================>
        //Edit By TOM connect to DATABASE SQL SERVER \/
        ClassDBSql DBSQL = new ClassDBSql();
        ///====================================================>
		...
		private void DisplayMicrTextImpl(ErrorCode errResult, CMicrResult cMicrResult)
		{
			...
			if (errResult == ErrorCode.SUCCESS)
			{
                ...
                /// SERVER CONNECT STEP 2
                ///====================================================>
                //Edit By TOM connect to DATABASE SQL SERVER \/                
                DBSQL.MicRs = edtMicrText.Text;
                DBSQL.Drivers = CbDrivers.Text;
                DBSQL.dateScan = DTPdateScans.Value.ToString("yyyy-MM-dd");
                
               // System.IO.File.Move("+DBSQL.PicCheque, dd + "\\" + DBSQL.MicRs+".jpg");
               // DBSQL.PicCheque = DBSQL.MicRs; // เปลี่ยน ชื่อภาพ เป็น Micr

                DBSQL.InsertSQL();
                // Edit By TOM connect to DATABADE SQL SERVER /\
                ///===================================================>
		...
		private string PrepareFolder()
		{
            ...
            //This is folder for result:\/  Edit By TOM
			...
			if (bSave)
			{
				...
				try
				{
					if (cImageResult.GetImageData() != null)
					{
                        ...
                        //======================================================================================>
                        /////////////////////////////////Edit By Tom//////////////////////////////////////////////
                        DBSQL.PicCheque = nTransactionNumber.ToString("000") + ("_Image_")
                                     + (cImageResult.GetLightSource() == ImageType.MF_SCAN_IMAGE_INFRARED ? "IR_" : "")
                                      + ("Front") + (".")
                                     + strExt;
                        ////////////////////////////////////////////////////////////////////////////////
